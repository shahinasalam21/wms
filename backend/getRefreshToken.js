import { OAuth2Client } from "google-auth-library"; // ✅ Fix Import
...
const REDIRECT_URI = "http://localhost:5000/auth/callback"; // Match with Google Console

const SCOPES = ["https://www.googleapis.com/auth/calendar"];

const oauth2Client = new OAuth2Client(CLIENT_ID, CLIENT_SECRET, REDIRECT_URI); // ✅ Fix Here
